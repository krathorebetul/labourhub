              ...
              <table className="table table-bordered table-striped">
                <thead className="thead-dark">
                  <tr className="text-center">
                    ...
                    <th scope="col" className="text-light">Labour Pic</th>
                    <th scope="col" className="text-light bg-warning">Registred By</th>
                    <th scope="col" className="text-light">Labour Name</th>
                    <th scope="col" className="text-light">Labour Password</th>
                    ...
                    <th scopr="col" className="text-light">Labour Type</th>
                  </tr>
                </thead>
                <tbody>
                  {
