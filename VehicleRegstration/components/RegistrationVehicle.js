...
const RegistrationVehicle = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (isEmpty(id)) {
            ...
            alert("Your password is " + contactid)
    ...
    const datainsert = () => {
        ...
        firebaseDb.ref("vehicle_reg").push(initialVehicle, (err) => {
            if (err) {
                alert("no");
            }
            else {
    ...
    return (
        <div>
            ...
            <div className="container p-5 my-5  border text-light border w-75">
                <h1 className="text-center">Labour Registration</h1>
                <form onSubmit={handleSubmit} autoComplete="off">
                    ...
                    <div className=" mb-3">
                        <label  className="form-label">Labour pic</label>
