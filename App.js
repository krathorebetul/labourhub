...
import AdminLoaderView from './Main/components/AdminLoaderView';
...
import Termsandconditins from "./Main/components/Termandconditions";
  ...
  return (
    <div className="App">
      ...
      <Switch>
        ...
        <Route exact path="/terms&conditions" component={Termsandconditins}/>
        {/* -----------------Login Registration------------- */}
        ...
        <Route exact path ="/adminloaderview/:id" component={AdminLoaderView}/>
